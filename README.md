...
**[⚓ Barenetes](https://github.com/do-2k25-28/Barenetes)** — Minimal container orchestration engine written in Rust<br>
*Open-source contributor*

**[🏋️ weight-estimation](https://github.com/nadouulh/weight-estimation)** — Deep Learning & Computer Vision for ergonomic evaluation (REBA score)<br>
